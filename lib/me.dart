    ...
    return Scaffold(
        ...
        body: Container(
            child: Column(
              ...
              Row(children: [
                Container(
                   margin: const EdgeInsets.fromLTRB(470, 20, 100, 0),
                   child: InkWell(
                      onTap: () {
                    ...
                    margin: const EdgeInsets.fromLTRB(400, 20, 100, 0),
                    child: InkWell(
                        onTap: () {
...
Row(children: [
                ...
                Container(
                      margin: const EdgeInsets.fromLTRB(550, 70, 700, 0),
...
Column(children: [
  Row(children: [
           Container(
                      margin: const EdgeInsets.fromLTRB(600, 80, 10, 0),
                    ...
                    Container(
                      margin: const EdgeInsets.fromLTRB(0, 80, 30, 0),
                ...
                Row(children: [
                            Container(
                      margin: const EdgeInsets.fromLTRB(600, 20, 10, 0),
